...
const EMPTY = { titre:'', contenu:'', image_url:'', mj_id:'', publie:true }
...
export default function AdminNews() {
  ...
  const startEdit = (a) => {
    setEditing(a.id)
    setForm({ titre:a.titre||'', contenu:a.contenu||'', image_url:a.image_url||'', mj_id:a.mj_id||'', publie:a.publie!==false })
